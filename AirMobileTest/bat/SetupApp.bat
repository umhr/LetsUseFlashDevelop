...
:: Android packaging
set AND_CERT_NAME="AirMobileTest"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AirMobileTest.p12
...
set IOS_PROVISION=cert\AirMobileTest.mobileprovision
